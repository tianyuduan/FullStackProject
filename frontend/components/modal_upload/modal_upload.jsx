...
class ModalUpload extends React.Component {
  ...
  handleUpload(e){
    ...
    window.cloudinary.openUploadWidget(
      window.cloudinary_options, function(error, images){
      if (error === null) {
        //upload successful
      } else {
  ...
  postImage(image_url) {
    let img = {image_url: image_url};
    $.post("/api/photos", function (images){
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="card">
        <img src="http://res.cloudinary.com/djubcegxh/image/upload/v1500678408/default_rfeohx.png" id="img-preview" />
